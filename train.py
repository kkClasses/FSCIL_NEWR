...
def get_command_line_parser():
    ...
    parser.add_argument('-project', type=str, default='base', choices=['teen','selfProb','NEWR','logitMixup'])
    ...
    parser.add_argument('-trainTest', type=str, choices=['train', 'test'], default='train')
    parser.add_argument('-NEWR', type=int, choices=[1, 0], default=0)
    parser.add_argument('-taskInfo', type=int, choices=[1, 0], default=0)
    parser.add_argument('-alpha', type=float, choices=[0.5, 0.9], default=0.5)
...
def add_commond_line_parser(params):
    ...
    elif (project == 'teen') | (project == 'logitMixup')| (project == 'selfProb') | (project == 'NEWR'):
        parser.add_argument('-softmax_t', type=float, default=16)
        parser.add_argument('-shift_weight', type=float, default=0.9, help='weights of delta prototypes')
